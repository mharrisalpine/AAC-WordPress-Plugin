...
<head>
	...
	<style>
		...
		body.aac-member-portal-embed .aac-managed-main {
			padding: 0;
		}

		body.aac-member-portal-embed .aac-managed-main__inner {
			max-width: none;
			margin: 0;
		}
		...
		body.aac-member-portal-embed .aac-managed-card--embed {
			margin: 0;
			padding: 0;
			border: 0;
			background: transparent;
	...
	@media (max-width: 640px) {
		...
		@media (max-width: 720px) {
			...
			body.pmpro-checkout.aac-member-portal-embed .aac-managed-main {
				padding: 0;
			}
			...
			body.pmpro-checkout .aac-managed-card .aac-checkout-step__nav-button:first-of-type {
				flex: 0 0 6rem;
			}
		...
		body.pmpro-checkout .aac-managed-card .aac-magazine-addons__input:checked + .aac-magazine-addons__card {
			border-color: rgba(12, 10, 9, 0.88);
			box-shadow: none;
		}
		...
		@media (max-width: 720px) {
			...
			body.pmpro-checkout .aac-managed-card .aac-membership-discounts__copy span,
			body.pmpro-checkout .aac-managed-card .aac-magazine-addons__copy span {
				font-size: 0.9rem;
				line-height: 1.45;
			}
		...
		const ensureCheckoutWizardShell = () => {
			...
			stepDefinitions.forEach((step, index) => {
				...
				if (!isLastStep) {
					...
					nextButton.textContent = window.matchMedia('(max-width: 720px)').matches
						? 'Continue'
						: `Continue to ${stepDefinitions[index + 1]?.label || 'Next Step'}`;
