...
const DiscountCard = ({ card, index, membershipPercent, membershipCodeText, membershipTierLabel, portalDesign, portalContent, handleVisitOffer }) => (
  <motion.article
    key={card.id}
  ...
  >
    ...
    <div className="flex flex-1 flex-col px-4 py-4">
      ...
      {(card.displayText || card.buttonUrl) ? (
        <details className="group mt-3 rounded-[0.9rem] border border-stone-200/90 bg-white/70">
          ...
          <div className="border-t border-stone-200/80 px-3 py-3">
            {card.displayText ? (
              <p className="text-[0.82rem] leading-5 text-black/70">{card.displayText}</p>
            ) : null}
            {card.buttonUrl ? (
              <div className="pt-3">
                <Button
