...
export function useMembershipSignup({ mode, isActive, onDismiss }) {
  ...
  const buildAccountPayload = () => ({
    ...
    aaj_pref: profile?.account_info?.aaj_pref || 'Digital',
    anac_pref: profile?.account_info?.anac_pref || 'Digital',
    acj_pref: profile?.account_info?.acj_pref || 'Digital',
